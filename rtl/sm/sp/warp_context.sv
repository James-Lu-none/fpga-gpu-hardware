...
`ifdef ENABLE_GPU_DEBUG
    ...
    assign debug_warp_status = {
        simt_sp[1][1:0], warp_state[1][1:0], warp_pc[1][11:0], // [31:16]: Warp 1
        simt_sp[0][1:0], warp_state[0][1:0], warp_pc[0][11:0]  // [15:0]:  Warp 0
    };

    assign debug_warp_extra = {
